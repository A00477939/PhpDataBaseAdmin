            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="text-center">Quiz Category Details
                        </h4>
                       
                    </div>
                        <!-- Trigger the modal with a button -->
                        <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Add Quiz</button>
                                        ...
                                        foreach($query_run as $quiz)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="QuizUpdate.php?id=<?= $quiz['QUIZID']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                    </form>

                                                   <form action="QuizFunction.php" method="POST" class="d-inline">
                                                    <button type="submit" name="delete_quiz" value="<?=$quiz['QUIZID'];?>" class="btn btn-danger btn-sm">Delete</button>
                                                    </form>
                                                </td>
                                            </tr>
                                            <?php
